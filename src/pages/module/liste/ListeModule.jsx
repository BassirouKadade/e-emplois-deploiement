...
import {listeModule,supprimerModule, searchModuleNext } from '../../../request/moduleRequest/moduleRequest';
...
return (
    <section className='formateurs-container'>
         <Helmet>
      <title>Liste-Module | E-Emplois</title>        <meta name="description" content="Gérez votre profil et vos emploi du temps sur E-emplois. Accédez aux statistiques et aux informations importantes." />
